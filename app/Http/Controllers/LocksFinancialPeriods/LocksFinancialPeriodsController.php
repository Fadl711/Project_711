...
class LocksFinancialPeriodsController extends Controller
{
    ...
    -> where('accounting_period_id', $accountingPeriodOpen->accounting_period_id)
...
//   dd($totalExpenses);
        ...
        return view('locks_financial_period.index',['accountingPeriodOpen'=>$accountingPeriodOpen]);
    }
    ...
    public function getProfitAndLossData(Request $request,$id)
{
    ...
    if (!AccountingPeriod::where('is_closed', false)->exists()) {
     ...
     AccountingPeriod::create([
        ...
        $subAccounts=SubAccount::whereIn('typeAccount', [1,2,3,5])->get();
