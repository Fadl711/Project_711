...
class SubaccountController extends Controller
{
    ...
    public function allShow()
    {
        ...
        foreach ($SubAccounts as $s){
            ...
            dd($s->mainAccount->accountTypeLabel());
        }*/
        ...
        if ($request->ajax()) {
            ...
            foreach ($SubAccounts as $SubAccount) {
                ...
                $output .= '<tr class="bg-white transition-all duration-500 hover:bg-gray-50 text-right">' .
                    ...
                    '<td class="tagTd">' . $SubAccount->mainAccount->accountClassLabel() . '</td>' .
                    ...
                    '</svg>' .
                    '</a>' .
                    '<a href="#" class="mt-[6px] focus:outline-none  rounded-full  group transition-all duration-500  flex item-center delete-payment" data-id="{{$SubAccount->sub_account_id}}" >' .
