            ...
            <tr class="transition-all duration-500">
                ...
                <td class=" border text-right flex">
                    ...
                    <svg class="w-6 h-6 text-[#2430d3] dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                      ...
                      <a href="{{route('receip.edit',$PaymentBond->payment_bond_id)}}"  class="text-sm py-2 px-2  leading-none rounded-md hover:bg-gray-100" >                        <svg class="w-6 h-6 text-[#2430d3] dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
