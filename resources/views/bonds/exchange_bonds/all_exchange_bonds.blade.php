...
<div class=" text-sm">
    ...
    <table class="min-w-full bg-white  text-sm " >
        ...
        <tbody >
            @foreach ($PaymentBonds as $PaymentBond)
            <tr class="transition-all duration-500">
                ...
                <td class=" border text-right flex">
                    <a href="{{route('exchange.show',$PaymentBond->payment_bond_id)}}"  class="text-sm py-2  leading-none rounded-md hover:bg-gray-100" >
                    ...
                    <svg class="w-6 h-6 text-[#2430d3] dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                      ...
                      <a href="{{route('exchange.edit',$PaymentBond->payment_bond_id)}}"  class="text-sm py-2 px-2  leading-none rounded-md hover:bg-gray-100" >                        <svg class="w-6 h-6 text-[#2430d3] dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content bg-white rounded shadow-md">
                <div class="modal-header">
                  <h5 class="modal-title text-lg font-bold"> حذف سند صرف</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <p class="text-gray-600 text-center font-bold">هل انت متاكد من حذف هذالصرف?</p>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">الغاء</button>
                  <form action="{{route('exchange.destroy',$PaymentBond->payment_bond_id)}}" method="POST"  class="text-sm py-2 px-2  leading-none rounded-md hover:bg-gray-100" >
                    @csrf
                    @method('DELETE')
