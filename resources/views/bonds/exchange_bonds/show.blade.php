...
<div class="container relative " id="js-print-template" x-ref="printTemplate">
    {{-- <button onclick="window.history.back()">رجوع</button> --}}

    <div class="relative border-2 border-black rounded-b-lg my-2 ">
...
@endphp --}}
    ...
    {{-- body srart --}}
    <div class=" p-3 relative space-y-2  text-base bg-gray-200 border-black  rounded-lg  my-2 text-right font-bold">
        ...
        <div class="relative">
            <table class="relative bg-gray-100 container text-center  border-black border-2 ">
                <thead>
                    <tr class="bg-gray-300 ">
                        <th class="px-2 py-2  border-black border-2 " >م</th>
                        <th class=" min-w-[25%] max-w-[30%] border-black border-2">اسم الحساب </th>
                        <th class="px-2 py-2 min-w-[30%] max-w-[30%]  border-black border-2">البيان</th>
                        <th class="px-2 py-2 min-w-[20%] max-w-[20%]  border-black border-2">المبلغ </th>
                        <th class="px-2 py-2 min-w-[20%] max-w-[20%]  border-black border-2">العملة</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="text-right">
