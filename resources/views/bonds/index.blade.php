...
@section('conm')
        ...
        <ul class="grid grid-cols-4 text-right container relative shadow-md px-2 py-2  bg-white">
            <li class="   "> 
                ...
                <a href="{{route('Receip.create')}}"  class="{{ Request::is('Receip/create') ? 'text-blue-700 border-blue-700 text-lg border-2' : 'text-gray-600' }} text-sm  py-2   px-2   leading-none rounded-md hover:bg-gray-100" > سند قبض جديد</a>
            </li>
            <li class="    ">
