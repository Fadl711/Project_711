        ...
        <form action="" class="min-w-[30%]  ">
            <div class="flex">
                ...
                <div id="newProduc" class="col-span-6 sm:col-span-3 py-2" style="display:">
                    <button class="inputSale flex font-bold " type="button">
                ...
                <div class="flex">
                   <div class="px-1 ">
                        <label for="total" class="btn">تكلفة الصنف</label>
                ...
                <div class="flex">
                      <div class=" px-1 ">
                        <label for="address" class="btn">العلامة التجارية</label>
                        <input type="number" name="address" id="address" placeholder="" class="inputSale" />
                      </div>
                      <div class=" px-1 ">
                        <label for="address" class="btn">الوصف</label>
                            <textarea  name="description" id=""  placeholder="0"class="inputSale"></textarea>
                      </div>
                </div>
                <div class="flex">
                <div class="px-1 ">
                    <label for="num" class="labelSale">رقم الفاتورة</label>
                    <input type="text" name="num"  placeholder="0"class="inputSale" />
                </div>
                <div class=" px-1 ">
