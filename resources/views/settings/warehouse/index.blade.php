                ...
                <div class="w-full border-x border-y border-orange-950 rounded-xl">
                    <div class="px-1 flex justify-evenly">
                        <div >
                            ...
                            <input  id="Store_name" name="Store_name" type="text"  class="inputSale" />
                        </div>
                        <div>
                            <label for="Store_location" class="btn">موقع المخزن</label>
                        <input  id="Store_location" name="Store_location" type="text"  class="inputSale" />
                        </div>
                        <div>
                            <label for="Stock_level" class="btn">المستوى </label>
                        <input  id="Stock_level" name="Stock_level" type="text"  class="inputSale" />
                        </div>
                        @auth
                        <div>
        ...
        <table class=" w-full  rounded-xl">
            <thead>
                <tr class=" ">
                    ...
                    <th scope="col" class="leading-2  text-center ">اسم المخزن</th>
                    <th scope="col" class="leading-2  text-center "> موقع المخزن</th>
                    <th scope="col" class="leading-2  text-center "> مستوى المخزن</th>
                    <th scope="col" class="leading-2   text-right">تعديل المخزن</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-300 ">
                ...
                <tr class="bg-white transition-all duration-500 hover:bg-gray-50 border-b-2">
                    ...
                    <td class="text-center">{{$Warehouse->Store_name}}</td>
                    <td class="text-center">{{$Warehouse->Store_location}}</td>
                    <td class="text-center">{{$Warehouse->Stock_level}}</td>
                    <td class=" ">
                            <div class="flex items-center gap-1">

                                <a href="{{route('settings.warehouse.edit',$Warehouse->warehouse_id)}}"  class="p-1  rounded-full  group transition-all duration-500  flex item-center">
                                  ...
                                  <form action="{{route('settings.warehouse.destroy',$Warehouse->warehouse_id)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
...
<script>
    ...
    $(document).ready(function() {
     $('#newProduc  button').click(function(e) {
         ...
         $.ajax({
             type: 'POST',
             url: "{{ route('settings.warehouse.store') }}",
             data: formData,
             processData: false,
             contentType: false,
