                ...
                <tr class="px-2 bg-white transition-all duration-500 hover:bg-gray-50 border-b-2">
                    ...
                    <td class=" ">
                            <div class="flex items-center gap-1">
                                ...
                                <a href="{{route('settings.currencies.edit',$cur->currency_id)}}"  class="p-1  rounded-full  group transition-all duration-500  flex item-center">
                                  ...
                                  <form action="{{route('settings.currencies.destroy',$cur->currency_id)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
