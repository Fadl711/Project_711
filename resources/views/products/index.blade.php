...
<td class="tagTd max-w-10 truncate hover:overflow-visible relative" data-tooltip="{{$pro->note}}">
    {{$pro->note}}
</td>
                ...
                <td class="p-1 tagTd">
                    <div class="flex items-center gap-1">
                            ...
                            <a href="#" class="mt-[7px] focus:outline-none  rounded-full  group transition-all duration-500  flex item-center delete-payment" data-id="{{$pro->product_id}}" >
                            ...
                            <a  class="mt-[7px] focus:outline-none  rounded-full  group transition-all duration-500  flex item-center"  href={{route('Category.create',$pro->product_id)}}>
                              عرض  الوحدة
                                <svg class="" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                </svg>
                            </a>
