    ...
    {{$pro->note}}
                ...
                <td class="p-1 tagTd">
                    <div class="flex items-center gap-1">
                            ...
                            <button class=" focus:outline-none  rounded-full  group transition-all duration-500  flex item-center" data-toggle="modal" data-target="#delete-modal-{{$pro->product_id}}">
                ...
                <div class="modal" tabindex="-1" role="dialog" id="delete-modal-{{$pro->product_id}}">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content bg-white rounded shadow-md">
                        ...
                        <div class="modal-footer">
                          ...
                          <form action="{{route('products.destroy',$pro->product_id)}}" method="POST"  class="text-sm py-2 px-2  leading-none rounded-md hover:bg-gray-100" >
                            @csrf
                            @method('DELETE')
