         ...
         <div class="md:flex md:justify-around text-right">
                <div class=" px-1">
                    <div class="mb-1">
                        ...
                        <input type="text" name="name" id="contact_person _name" class="inputSale">
                    </div>
                </div>
                 <div class=" px-1">
                    <div class="mb-1">
                        <label for="barcod" class="labelSale">الباركود</label>
                        <input type="number" name="barcod" id="contact_person _name" placeholder="0" class="inputSale"/>
                    </div>
                </div>
                ...
                <div class="max-md:w-52 px-1 ">
                    <div class="mb-1">
                            ...
                            <textarea  name="description" placeholder="" class="inputSale h-9"></textarea>
                    </div>
                 </div>
...
var Products=document.getElementById("newProducts");
...
var ProductsTable=document.getElementById("ProductsTable");
    ...
    } else if(ProductsTable.style.display=="block")
    {
        ProductsTable.style.display="block";
        Products.style.display="none";
