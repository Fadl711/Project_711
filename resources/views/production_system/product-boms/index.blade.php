    ...
    <div class="container">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('product-boms.create') }}" class="ajax-link btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($boms as $index => $bom)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('product-boms.edit', $bom->id) }}" class="btn btn-sm btn-warning"
                                            title="تعديل">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('product-boms.destroy', $bom->id) }}" method="POST"
