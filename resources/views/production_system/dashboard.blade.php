...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="flex justify-between items-center p-4 border-b">
            ...
            <a href="{{ route('production_lines.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">الكفاءة</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('production_lines.show', $line) }}" class="text-blue-600 hover:text-blue-900 mr-3">عرض</a>
                            <a href="{{ route('production_lines.edit', $line->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">تعديل</a>
                            <form action="{{ route('production_lines.destroy', $line->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
