    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                <a href="{{ route('production-stages.create') }}"
                    class="ajax-link bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            <form action="{{ route('production-stages.index') }}" method="GET"
                ...
                <div class="flex items-end">
                    <button type="submit"
                        class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md w-full flex items-center justify-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd"
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col"
                                ...
                                الاسم</th>
                            <th scope="col"
                                class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">خط
                                الإنتاج</th>
                            <th scope="col"
                                class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                                الترتيب</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class=" bg-gray-50 ">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <div class="flex items-center">
                                        <span class="flex-shrink-0 h-4 w-4 rounded-full"
                                            style="background-color: {{ $stage->productionLine->color }}"></span>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2 space-x-reverse">
                                        <a href="{{ route('production-stages.show', $stage) }}"
                                        ...
                                        {{-- @if (!$stage->trashed()) --}}
                                        <a href="{{ route('production-stages.edit', $stage) }}"
                                        ...
                                        <form action="{{ route('production-stages.toggle-status', $stage) }}"
                                            ...
                                            <button type="submit" class="text-gray-600 hover:text-gray-900"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                                    ...
                                                    @else
                                                        <path fill-rule="evenodd"
                                                            d="M18 8a6 6 0 01-7.743 5.743L10 14l-1 1-1 1H6v2H2v-4l3.743-3.743A6 6 0 1118 8zm-6-4a1 1 0 100 2 2 2 0 012 2 1 1 0 102 0 4 4 0 00-4-4z"
                                                            clip-rule="evenodd" />
                                                    @endif
                                                </svg>
                                            </button>
                                        ...
                                        <form action="{{ route('production-stages.destroy', $stage) }}" method="POST"
                                            class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-red-600 hover:text-red-900" title="حذف"
                                                onclick="return confirm('هل أنت متأكد من حذف مرحلة الإنتاج؟')">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">لا توجد مراحل إنتاج
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
