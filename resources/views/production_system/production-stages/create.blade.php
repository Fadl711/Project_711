            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('production-stages.index') }}"
                        class="ajax-link text-gray-600 hover:text-gray-900 flex items-center">
                ...
                <form action="{{ route('production-stages.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-6 mb-6">
                        ...
                        <!-- ترتيب المرحلة -->
                        <div>
                            <label for="sequence" class="block text-sm font-medium text-gray-700 mb-1">ترتيب المرحلة
                                *</label>
                        ...
                        <!-- الهدف من المرحلة -->
                        <div>
                            <label for="purpose" class="block text-sm font-medium text-gray-700 mb-1">الهدف من
                                المرحلة</label>
                        ...
                        <!-- المدة المعيارية -->
                        <div>
                            <label for="standard_duration" class="block text-sm font-medium text-gray-700 mb-1">المدة
                                المعيارية (ثانية/وحدة) *</label>
                            <input type="number" step="0.01" min="0" name="standard_duration"
                                id="standard_duration" required value="{{ old('standard_duration') }}"
                        ...
                        <div>
                            <label for="target_yield" class="block text-sm font-medium text-gray-700 mb-1">النسبة المستهدفة
                                للجودة (%) *</label>
                            <input type="number" step="0.01" min="0" max="100" name="target_yield"
                                id="target_yield" required value="{{ old('target_yield', 100) }}"
                        ...
                        <div>
                            <label for="max_defect_rate" class="block text-sm font-medium text-gray-700 mb-1">أقصى نسبة عيوب
                                مسموح بها (%) *</label>
                            <input type="number" step="0.01" min="0" max="100" name="max_defect_rate"
                                id="max_defect_rate" required value="{{ old('max_defect_rate') }}"
                        ...
                        <!-- المعدات المطلوبة -->
                        <div>
                            <label for="required_equipment" class="block text-sm font-medium text-gray-700 mb-1">أكواد
                                المعدات المطلوبة</label>
                        ...
                        <!-- إعدادات المعدات -->
                        <div>
                            <label for="equipment_settings" class="block text-sm font-medium text-gray-700 mb-1">إعدادات
                                المعدات (JSON)</label>
                        ...
                        <!-- معايير الجودة -->
                        <div>
                            <label for="quality_parameters" class="block text-sm font-medium text-gray-700 mb-1">معايير
                                الجودة (JSON)</label>
                        ...
                        <!-- تعليمات الفحص -->
                        <div>
                            <label for="inspection_instructions"
                                class="block text-sm font-medium text-gray-700 mb-1">تعليمات الفحص</label>
