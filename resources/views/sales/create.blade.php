...
@section('conm')
    ...
    <div id="successMessage"class="hidden fixed top-4 right-4 bg-green-500 text-white px-6 py-4 rounded-lg shadow-lg"
        role="alert"></div>
    <div id="errorMessage" class="hidden fixed top-2 right-4 bg-red-500 text-white px-6 py-1 rounded-lg shadow-lg"
        role="alert"></div>
                ...
                <form id="invoiceSales" method="POST">
                    ...
                    <div class="grid md:grid-cols-8   gap-2 text-right">
                        ...
                        <div>
                            ...
                            <select dir="ltr" id="currency_id" class="inputSale input-field select2"
                                name="currency_id">
                                @isset($Currency_name)
                        ...
                        <div>
                            ...
                            <input type="text" name="total_price_sale" id="total_price_sale" class="inputSale"
                        ...
                        <div>
                            ...
                            <input type="text" name="net_total_after_discount" id="net_total_after_discount"
                                class="inputSale" />
                        </div>
                        @auth
                            ...
                            <div class="text-center">
                                <div class="text-center">
                                    @foreach (['1' => 'تلقائي', '2' => 'يدوي'] as $key => $label)
                                        <input type="radio" name="listRadio" value="{{ $key }}"
                                            {{ $key == 1 ? 'checked' : '' }} class="mr-2"> {{ $label }}
                                    @endforeach
                                </div>
                                <input id="date" name="date" type="date" class="inputSale"
                    ...
                    <div class="grid grid-cols-6 gap-2 text-right " id="">
                        ...
                        <div class="  gap-2 text-right " id="">
                            <div>
                                ...
                                <select name="financial_account_id" id="financial_account_id" dir="ltr"
                                        ...
                                        @isset($financial_account)
                                            @foreach ($financialts as $financialt)
                                                @if ($financialt->sub_account_id == $financial_account)
                                                    <option selected value="{{ $financialt->sub_account_id }}">
                                                        {{ $financialt->sub_name }}</option>
                                                @endif
                                            @endforeach
                                        @endisset
                                    @endisset
    ...
    <div class="flex max-md:block p-1">
            ...
            <form id="ajaxForm">
                ...
                <div class="gap-2 grid grid-cols-2 px-1">
                    <div>
                        ...
                        {{-- warehouse_to_id --}}
                        <select name="account_debitid" id="account_debitid" dir="ltr"
                            class="input-field select2 inputSale" required>
                            @isset($Warehouse)
                    ...
                    <div>
                        ...
                        <select name="Supplier" id="Supplier" dir="ltr"
                            class="input-field w-full select2 inputSale">
                ...
                <div class="grid grid-cols-1 gap-1 px-1">
                    <div>
                        ...
                        <select name="product_id" id="product_id" dir="ltr" class="input-field select2 inputSale"
                            required>
                            @isset($products)
                ...
                <div class="grid grid-cols-4 gap-1 px-1">
                    <div>
                        ...
                        <select name="Categorie_name" id="Categorie_name" dir="ltr"
                            class="input-field select2 inputSale" required>
                            <option selected value=""></option>
                        </select>
                    </div>
                    <div>
                        ...
                        <input type="text" name="QuantityCategorie" id="QuantityCategorie" placeholder="0"
                    ...
                    <div>
                        ...
                        <input type="text" name="Quantity" id="Quantity" placeholder="0"
                            class="inputSale quantity-field english-numbers" required />
                    </div>
                    <div>
                        <label for="Quantityprice" class="labelSale">الجمالي الكميه</label>
                        <input type="text" name="Quantityprice" id="Quantityprice" placeholder="0"
                            class="inputSale english-numbers" required />
                    </div>
                </div>
                <div class="grid grid-cols-3 gap-1 px-1">
                    ...
                    <div>
                        ...
                        <input type="text" name="Selling_price" id="Selling_price" placeholder="0"
                            class="inputSale" />
                    </div>
                    <input type="hidden" name="Purchase_price" id="Purchase_price" placeholder="0"
                        class="inputSale" />
                    <input type="hidden" name="total_Purchase_price" id="total_Purchase_price" placeholder="0"
                        class="inputSale total-fieldP" />
                    <div>
                        <label for="discount_rate" class="labelSale">نسبة الخصم</label>
                        <select name="discount_rate" id="discount_rate" dir="ltr"
                            class="input-field select2 inputSale" required>
                        </select>
                    </div>
                    <div>
                        <label for="total_discount_rate " class="labelSale">الخصم</label>
                        <input type="text" name="total_discount_rate" id="total_discount_rate" placeholder="0"
                            class="inputSale" />
                ...
                <div class="grid grid-cols-3 gap-1 px-1">
                    ...
                    <div>
                        ...
                        <input type="text" name="QuantityPurchase" id="QuantityPurchase" placeholder="0"
                            class="inputSale english-numbers" />
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-3 gap-1 px-1">
                    <div>
                        ...
                        <input type="text" name="Total" id="Total" placeholder="0"
                            class="inputSale total-field " required />
                    </div>
                    <div>
                        <label for="total_price" class="labelSale"> الإجمالي الصافي </label>
                        <input type="text" name="total_price" id="total_price" placeholder="0" class="inputSale"
                            required />
                    </div>
                    <div>
                ...
                <div class="flex px-1 gap-1">
                    <div>
                        ...
                        <input type="number" name="sales_invoice_id" id="sales_invoice_id" placeholder="0"
                            class="inputSale" required />
                    </div>
                    <div class="">
                        <button class="flex  mt-4 p-2 bg-red-600 text-white rounded hover:bg-red-700" type="button"
                            id="delete_invoiceSales">حذف الفاتورة</button>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <div class="w-full text-center  flex">
                            @foreach (['1' => 'تلقائي', '2' => 'تحليل'] as $key => $label)
                                <div class=" ">
                                    <input type="radio" name="analysis" value="{{ $key }}"
                                        {{ $key == 1 ? 'checked' : '' }} class="mr-2"> {{ $label }}
                                </div>
                            @endforeach
                        </div>
                        <div class="flex gap-2">
                            ...
                            <button onclick="openInvoiceWindow(event)"
                                class="px-4 py-2 bg-[#2430d3] text-white rounded hover:bg-blue-700" data-size="0">فاتورة
                                كبيره</button>
                            <button onclick="openInvoiceWindow(event)"
        ...
        <div class="container mx-auto  " id="mainAccountsTable">
            <div class=" overflow-x-auto  shadow-md sm:rounded-lg bg-white   w-full px-4 py-2   max-h-[80vh]">
                <table id="mainAccountsTable"
                    class="text-sm   font-semibold w-full overflow-y-auto max-h-[80vh] border-collapse">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                            ...
                            success: function(response) {
                                if (response.product) {
                                    ...
                                    $('#Purchase_price').val(response.product.Purchase_price)
                                        .trigger('change');
                                    $('#QuantityCategorie').val(response.product.Quantityprice)
                                        .trigger('change');
                                    $('#Selling_price').val(response.product.Selling_price)
                                        .trigger('change');
                                } else {
                                    console.error(
                                        'لم يتم العثور على المنتج أو السعر غير متوفر.');
                                }
                            },
                            error: function(xhr) {
                                console.error('حدث خطأ في الحصول على المنتج.', xhr
                                    .responseText);
                            }
                        });
                    };
                ...
                $('#product_id').on('change', function() { // عند تغيير المنتج المختار في القائمة
                    ...
                    var account_debitid = $('#account_debitid')
                        .val(); // الحصول على قيمة المنتج المختار
                    emptyDataProduct();
                        ...
                        $.ajax({
                            ...
                            success: function(product) {
                                ...
                                $('#Categorie_name').select2(
                                    'open'); // فتح قائمة الفئات
                            },
                            error: function(xhr) {
                                console.error('Error:', xhr
                                    .responseText
                                ); // عرض الخطأ إذا حدث خطأ في الاستدعاء
                            }
                        });
                    } else {
        ...
        function openInvoiceWindow(e) {
            ...
            if (invoiceField) {
                let size = $(e.target).data('size'); // الحصول على حجم الفاتورة من الزر الذي تم النقر عليه
        ...
        $(document).ready(function() {
            ...
            function handleAjaxError(xhr) {
                if (xhr.status === 422) {
                    ...
                    alert('خطأ في الاتصال! لم يتم الاتصال بالخادم، يرجى المحاولة لاحقًا. (رمز الخطأ: ' + xhr
                        .status + ')');
                }
            }
