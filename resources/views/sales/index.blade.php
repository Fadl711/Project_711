    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                 class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-moda">
            ...
            <form class="p-4 md:p-5">
                ...
                <div class="md:ml-2 ">
                  <label class="labelSale" for="payment_type">القسم  المستلم</label>
                ...
                <div class="md:ml-2">
                    <label class="labelSale" for="email">القسم المرسل</label>
                ...
                <div class="md:mr-2">
                    <label class="labelSale" for="password">المبلغ المدفوع</label>
...
<div  class="w-full   px-2   sm:rounded-lg  border-x border-y border-orange-950 rounded-xl p-2">
        <div class="w-full ">
            <form class="">
                <div class="md:flex md:justify-around">
                    <div class="md:ml-2">
                        <span class="text-right "> بيانات فاتورة العميل</span>
                    ...
                    <div class="md:ml-2 ">
                      ...
                      <input name="payment_type" list="datas" class="inputSale" id="payment_type" placeholder="دائن">
                    <datalist class="inputSale" id="datas">
                    ...
                    <div class="" id="newInvoice" onclick="NewProduct()" style="display: block">
...
<br>
     ...
     <div class=" min-w-[20%] px-1  border-x border-y border-orange-950 rounded-xl p-2 ">
            ...
            <div id="newProduct" class="col-span-6 sm:col-span-3 py-2" style="display: none">
            <button class="inputSale flex font-bold ">
            ...
            <div class="flex mt-2">
                <div class="col-span-6 sm:col-span-3">
                    <input type="text" name="price" id="price" class=" inputSale" placeholder="الخصم المسموح" required="">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <select name="" id="" class="inputSale">
                        <option value="">تفعيل </option>
                        <option value="" selected> الغاء </option>
                    </select>
                </div>
            </div>
            <input type="text" name="price" id="price" class=" inline-flex inputSale mb-2" placeholder="اجمالي الخصم" required="">
            <div class="col-span-6 sm:col-span-3">
                <label for="brand" class="labelSale "> الإجمالي </label>
                <input type="number" name="price" id="price" class="inputSale " placeholder="0" required="">
            </div>
            <div class="col-span-6 sm:col-span-3" id="payment" style="display: none">
            <button class="flex inputSale mt-2" data-modal-target="crud-moda" data-modal-toggle="crud-moda"  type="button">
                ...
                <g id="SVGRepo_iconCarrie">
                        <path stroke="currentColor" stroke-linecap="square" stroke-linejoin="round"
                         stroke-width="2" d="M16.5 15v1.5m0 0V18m0-1.5H15m1.5 0H18M3 9V6a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v3M3 9v6a1 1 0 0 0 1 1h5M3 9h16m0 0v1M6 12h3m12 4.5a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Z"/>
                                      </g>
                <span class="textNav mr-1"> دفع</span>
                </svg>
            </button>
            </div>


        <div class="flex"  id="printEndSave" style="display: none">
            <div class="col-span-6 sm:col-span-3">
        ...
        <table class=" min-w-[85%]  ">
            ...
            <tbody class="divide-y divide-gray-300 ">
                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                    <td class="tagTd  border-r border-r-orange-950">Louis Vuitton</td>
                    <td class="tagTd border-r border-r-orange-950 "> $2550 </td>
                    <td class="tagTd"> 510 </td>
                    <td class="tagTd"> 20010510 </td>
                    <td class="tagTd border-l  border-l-orange-950">
...
function NewProduct(){
  ...
  var newproduct= document.getElementById('newProduct');
    if(newproduct.style.display="none"){
