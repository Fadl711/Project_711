    ...
    <table class="w-full text-left mb-8">
        <thead>
                ...
                <tr class="border-b border-b-indigo-700  " style="display:">
                    <th class="text-center text-indigo-700   ">وصف</th>
                    <th class="text-center text-indigo-700 ">	كمية</th>
                    <th class="text-center text-indigo-700  ">سعر</th>
                    <th class="text-center text-indigo-700  ">المجموع</th>
        ...
        <tbody>
            ...
            <tr >
                ...
                <td class="py-1 text-gray-700 text-center">Product 1</td>
                <td class="py-1 text-gray-700 text-center">1</td>
                <td class="py-1 text-gray-700 text-center">$100.00</td>
                <td class="py-1 text-gray-700 text-center">$100.00</td>
