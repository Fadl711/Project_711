...
@section('refunds')
<div class="  px-1   " style="display:block ">
    <div class=" flex items-center py-2" >
        <div class=" w-full  bg-white" >
            
            <div class=" md:flex md:justify-around  px-2   border rounded shadow-md " >
               
            <div class="  container grid grid-cols-2 gap-1 py-2">
                <div class=" text-center xl:grid grid-cols-3 gap-1 ">
                    <div  class=" text-center  ">  
                        {{-- <label for="num" class="labelSale">  نوع المردود </label> --}}
                        <div class="flex gap-4">
                            
                            <div class="flex gap-1" >
                            <label for="inline-radio" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">نقدآ</label>
                            ...
                            <div class="flex gap-1">
                            <label for="inline-2-radio" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">آجل</label>
                  ...
                  <div  class=" text-center  ">  
                    ...
                    <label for="Supplirname" class="labelSale "> اسم العميل</label>
                 ...
                 <div  class=" text-center  ">  
                    <label for="num" class="labelSale">رقم فاتورة المبيعات</label>
                    <select   dir="ltr" id="accountty" class="inputSale "  required>
                    <option value="CA" selected>  </option>
                    <option value="US" >حساب رئيسي </option>
                    <option value="DE">فرعي</option>
                 ...
                 <div class="text-center  xl:grid grid-cols-3  gap-1">  
                  <div class="text-center ">  
                    <label for="Supplirname" class="labelSale "> اسم المخزن</label>
                  <input id="maont" type="number" class="inputSale " placeholder="505,550" required> 
                  </div>
                
                  <div class="text-center "> 
                    <div  class=" text-center  ">  
                        <label for="num" class="labelSale">  التاريخ</label>
                        <select   dir="ltr" id="accountty" class="inputSale "  required>
                        <option value="CA" selected>  </option>
                        <option value="US" >حساب رئيسي </option>
                        <option value="DE">فرعي</option>
...
<div class="flex  py-2 gap-x-2">
    <div class="   rounded shadow-md border">
        <form action="" class=" ">
            <div class="flex max-md:block gap-x-4">
                ...
                <div id="newProduc" class="col-span-6 sm:col-span-3 py-2 p-1" style="display:">
                ...
                <div class="flex max-md:block ">
                     ...
                     <div class="text-center px-1">
                        <label for="pricesa" class="btn">سعر </label>
                ...
                <div class=" px-1  text-center">
                    ...
                    <div class=" px-1 text-center">
                        <label for="discount" class="btn">الخصم</label>
                ...
                <div class="flex max-md:block">
                      ...
                      <div class=" px-1 text-center  w-full">
                        <label for="address" class="btn">السبب</label>
...
<div class="  overflow-x-auto container   px-1">
    <div class=" rounded-lg  max-h-[500px] ">
<table class=" min-w-[100%]  ">
            <thead>
                <tr class="tagTr">
                    <th scope="col" class=" tagHt ">اسم الصنف</th>
                    <th scope="col" class=" tagHt ">السعر</th>
                    <th scope="col" class=" tagHt">الكمية</th>
                    <th scope="col" class=" tagHt"> الإجمالي</th>
                    <th scope="col" class=" tagHt"> الخصم</th>
