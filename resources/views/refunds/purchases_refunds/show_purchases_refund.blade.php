            ...
            <td class="py-1   text-right bg-white"> 
                ...
                <div class=" md:flex md:justify-around  px-1   border rounded shadow-md   text-sm " >
                   ...
                   <div class="min-w-full  container grid grid-cols-2 gap-1 py-1 ">
                        ...
                        <div class="text-right  lg:grid grid-cols-4    ">  
                           <div class="text-right ">            
                                    <label for="i" class=" text-sm font-medium text-[#2430d3]"> اسم المورد : جمال علي احمد سعد </label>
                               </div>
                         <div class="text-right ">  
                           <label for="Supplirname" class=" text-sm font-medium ">  رقم المردود : 1 </label>
                         </div>
                       
                         <div class="text-right "> 
                           <div  class=" text-right  ">  
                               <label for="num" class=" text-sm font-medium">  نوع المردود: اجل </label>
                                
                                         </div> 
                           
                             </div>
                             <div id="newInvoice "  class=" text-right">
                               <label for="num" class=" text-sm font-medium text-red-700">التاريخ : <span>2024/10/11</span> </label>
                               </div>
                             ...
                             <div id="newInvoice"  >
                               ...
                               <div id="newInvoice " class=" " >
                                   <label for="num" class=" text-left">
                                       <a href="{{route('purchase_refund.show')}}"  class="text-sm py-2  leading-none rounded-md hover:bg-gray-100" >                    
