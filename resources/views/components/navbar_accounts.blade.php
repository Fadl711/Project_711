<nav class=" shadow-md bg-white ">
 ...
 <a href="{{route('Main_Account.create')}}"   class="py-2 px-4 {{ Request::is('accounts/Main_Account/create') ? '   border-b-2   text-[#0a0aeec6]' : 'border-b-0' }} border-[#0a0aeec6]   leading-none rounded hover:bg-gray-50" >اضافة حساب رئيسي</a>
        ...
        <a href="{{route('subAccounts.allShow')}}"  class="py-2 px-4 {{ Request::is('accounts/subAccount/allShow') ? '   border-b-2   text-[#0a0aeec6]' : 'border-b-0' }} border-[#0a0aeec6]   leading-none rounded hover:bg-gray-50" >  الحسابات الفرعية</a>
        ...
        <a href="{{ route('accounts.review_budget', ['year' => now()->year, 'month' => now()->month]) }}" class="py-2 px-4 {{ Request::is('accounts/review-budget') ? 'border-b-2 text-[#0a0aeec6]' : 'border-b-0' }} border-[#0a0aeec6] leading-none rounded hover:bg-gray-50">
            مراجعة الحسابات
          </a>
