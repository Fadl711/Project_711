<nav class="w-full px-2 py-1">
    <ul
        class="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-2
        ...
        <li class="text-center lg:text-right">
            <a href="{{ route('restrictions.create') }}"
                class="block py-3 px-4 text-white hover:bg-indigo-700  text-nowrap
        ...
        <li class="text-center lg:text-right">
            <a href="{{ route('double_entry.all_double_entries') }}"
                class="block py-3 px-4 text-white hover:bg-indigo-700  text-nowrap
                      transition-colors duration-200
                      text-sm md:text-base
                      {{ Route::is('double_entry.all_double_entries') ? 'border-b-2 font-bold' : 'border-b-0' }}
                      border-white">
                القيود المزدوجة
            </a>
        </li>
