        ...
        <div class="min-h-screen bg-white">
            ...
            <div class="flex flex-col  w-40 h-full overflow-hidden text-gray-700 bg-gray-100 rounded ">
                ...
                <div class="w-full px-2">
                  <div class="flex flex-col items-center w-full mt-3 border-t border-gray-300">
                    <a href="/home" class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="#">
            ...
            <span class="ml-2 text-sm font-medium">العملاء</span>
              ...
              <div class="group fixed bottom-0 right-0 p-2  flex items-end justify-end w-24 h-24 ">
                ...
                <!-- sub left -->
                <a href="https://instagram.com/akashgandhar0" target="_blank"
                  ...
                  <svg class="w-5 h-5" width="800px" height="800px" viewBox="0 0 24 24" fill="none"
                ...
                <!-- sub top -->
                <a href="https://github.com/akashgandhar" target="_blank"
                  ...
                  <svg class="w-5 h-5" width="800px" height="800px" viewBox="0 0 48 48" id="Layer_2" data-name="Layer 2"
                    xmlns="http://www.w3.org/2000/svg">
                    <defs>
                      <style>
                        .cls-1 {
                ...
                <!-- sub middle -->
                <a href="https://veilstudio.in" target="_blank"
                  ...
                  <svg class="w-5 h-5" fill="#000000" width="800px" height="800px" viewBox="0 0 50 50"
