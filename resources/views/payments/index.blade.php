            ...
            <form>
             ...
             <div class="mb-4 md:flex md:justify-around">
                 ...
                 <div class="md:ml-2 ">
                     ...
                     <input name="payment_type" type="number" class="inputSale" placeholder="0"/>
                 </div>
                 <div class="md:ml-2">
                     <label class="labelSale" for="numberphone">رقم التلفون</label>
                ...
                <table class="tagTable">
                    <thead>
                         <tr class="bgcolor">
                            ...
                            <th scope="col" class="leading-2 tagHt">رقم المستلم</th>
                            <th scope="col" class="leading-2 tagHt" id="thName"></th>
                     ...
                     <tbody class="tagTtbody">
                        <tr class="tagTr">
                             <td class="tagTd">الصندوق</td>
                                  <td class="tagTd">550</td>
                                  <td class="tagTd">الموردين</td>
                                  <td class="tagTd">2</td>
                                  <td class="tagTd">الحارث</td>
