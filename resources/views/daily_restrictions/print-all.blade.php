...
<body class="bg-white">
    ...
    <div class="w-full border-2 border-black bg-[#1749fd15] rounded-lg">
        ...
        <div class="text-center">
            <p class="font-extrabold">  {{ $Myanalysis }} -   التقرير</p>
    ...
    @endif
    <div class="  bg-white shadow-md sm:rounded-lg    w-full px-4 py-2   ">
    ...
    <div class="mt-4 no-print">
        <button id="buttonh" onclick="printAndClose()" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700">طباعة</button>
...
<script>
    function printAndClose() {
        // $(".editHt").addClass("hidden");
                        ...
                        // $("th[class='editHt']").toggleClass("hidden ");
