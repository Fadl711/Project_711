            ...
            <div class="w-full   py-1">
                <form id="invoicePurchases" action="{{ route('double_entry.storeOrUpdate') }}" method="POST">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <div class="flex">
                            <label for="typeAcouunt" class="labelSale">دائن/عاطي</label>
                            <input id="typeAcouunt" type="radio" name="typeAccount" value="دائن" required>
                        </div>
                        <div class="flex">
                            <label for="typeAcouunt1" class="labelSale">مدين/اخذ</label>
                            <input id="typeAcouunt1" type="radio" name="typeAccount" value="مدين" required>
                        </div>
                    </div>
                    <div class=" text-right grid grid-cols-2 md:grid-cols-4 gap-1">
                        <div>
                            <label for="main_account_debit_id" class="main_accountdebit  labelSale"> حساب </label>
                        ...
                        <div>
                            <label for="sub_account_debit_id" class="labelSale  sub_account_debit_id "> تحديد الحساب</label>
                        ...
                        <div>
                            <label for="Statement1" class="block font-medium  text-center">البيان</label>
                            <textarea name="Statement" id="Statement1" class="w-full border rounded-md " rows=""></textarea>
                        </div>
                        @auth
                            <input type="hidden" name="User_id" id="User_id" value="{{ Auth::user()->id }}">
                        @endauth
                        <div id="newInvoice1 " class="w-1/2" style="display: block">
                            <button id="newInvoice" class="inputSale flex font-bold mt-4 ">
                                اضافة قيد مزدوج
                            </button>
                        </div>
                    </div>
    ...
    <div class="flex flex-col md:flex-row gap-4 p-4">
            ...
            <form id="ajaxForm">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gray-50 rounded-lg border border-gray-200 p-4">
                        <h3 id="h3Account" class="text-lg font-semibold text-gray-800 mb-3"></h3>
                        ...
                        <div>
                            <label id="account_Credit_id_label" for="account_Credit_id"
                                class="block font-medium mb-1"></label>
                            <select name="account_Credit_id" id="account_Credit_id" class="input-field select2 w-full"
                                required>
                        ...
                        <div class="mt-3">
                            <label id="sub_account_Credit_id_label" for="sub_account_Credit_id"
                                class="block font-medium mb-1"></label>
                            <select name="sub_account_Credit_id" id="sub_account_Credit_id"
                                class="input-field select2 w-full">
                                <option value="" selected>اختر الحساب الفرعي</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input name="Amount_debit" id="Amount_debit" type="text" class="input-field w-full"
        ...
        <div class="container mx-auto  " id="mainAccountsTable">
            ...
            <button onclick="openInvoiceWindow(event)"
                class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-700">فتح الفاتورة</button>
            <script>
            ...
            function displayProductDetails(product) {
                ...
                if (invoiceInput.length) {
                    ...
                    product.Categorie_names.forEach(categorie => {
                        $('#Categorie_name').append(new Option(categorie.Categorie_name, categorie
                            .categorie_id));
                    });
