            ...
            @endphp
                    ...
                    <tr class="transition-all duration-500">
                      ...
                      <a href="{{route('restrictions.edit',$eai->entrie_id)}}"  class="text-sm py-2 px-2  leading-none rounded-md hover:bg-gray-100" >
                        ...
                        <button class="mt-[10px] focus:outline-none  rounded-full  group transition-all duration-500  flex item-center" data-toggle="modal" data-target="#delete-modal-{{$eai->entrie_id}}">
                  ...
                  <!-- Modal -->
                  <div class="modal" tabindex="-1" role="dialog" id="delete-modal-{{$eai->entrie_id}}">
