...
$(document).ready(function() {
    $(document).on('click', '.delete-payment', function (e) {
        ...
        const act = "{{ route('daily_restrictions.destroy', ':id') }}"; // استخدم مُتغير
