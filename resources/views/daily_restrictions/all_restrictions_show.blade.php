            ...
            <tbody id="products-table">
                @forelse ($eail as $eai)
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200"
                        ...
                        <td class="border text-right bg-red-400">{{ $eai->amount_credit }} </td>
                        <td class="border text-right ">{{ $eai->statement }}/رقم المستند<span
                                class=" bg-red-400 px-1 rounded-md">{{ $eai->invoice_id }}</span></td>
                        </td>
                        <td class="border text-right bg-red-400">{{ $eai->currency_name }} </td>
                        ...
                        <td class="border text-right flex">
                            <a href="{{ route('restrictions.show', $eai->entrie_id) }}"
                                class="text-sm py-2 leading-none rounded-md hover:bg-gray-100">
                                <svg class="w-6 h-6 text-[#2430d3]" xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <a href="{{ route('restrictions.edit', $eai->entrie_id) }}"
                                class="text-sm py-2 px-2 leading-none rounded-md hover:bg-gray-100">
                            ...
                            <a href="#"
                                class="text-sm py-2 px-2 leading-none rounded-md hover:bg-gray-100 mt-[10px]    group transition-all duration-500  flex item-center delete-payment"
                                data-id="{{ $eai->entrie_id }}">
                                <svg class="" width="18" height="18" viewBox="0 0 20 20" fill="none"
