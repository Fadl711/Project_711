                    ...
                    <tr>
                        ...
                        <td class="text-right tagTd">
                            <div class="flex items-center gap-1">
                                <a href="{{ route('subAccounts.edit', $SubAccount->sub_account_id) }}"
                                ...
                                <a href="#"
                                    class="mt-[6px] focus:outline-none  rounded-full  group transition-all duration-500  flex item-center delete-payment"
                                    data-id="{{ $SubAccount->sub_account_id }}">
