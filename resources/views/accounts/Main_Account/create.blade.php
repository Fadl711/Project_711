   ...
   {{-- @if ($subAccount->Main_id==$mainAccount->sub_account_id)  --}}
    ...
    <td class="text-right tagTd">
        <div class="flex items-center gap-1">
          <a  href="{{route('accounts.Main_Account.edit',$main_account->main_account_id)}}"  class="p-1  rounded-full  group transition-all duration-500  flex item-center">
          ...
          <button class="p-1 focus:outline-none  rounded-full  group transition-all duration-500  flex item-center" data-toggle="modal" data-target="#delete-modal-{{$main_account->main_account_id}}">
      ...
      <!-- Modal -->
      <div class="modal" tabindex="-1" role="dialog" id="delete-modal-{{$main_account->main_account_id}}">
        <div class="modal-dialog" role="document">
          <div class="modal-content bg-white rounded shadow-md">
            ...
            <div class="modal-footer">
              ...
              <form action="{{route('accounts.Main_Account.destroy',$main_account->main_account_id)}}" method="POST">
                @csrf
                @method('DELETE')
