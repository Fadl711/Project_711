...
return new class extends Migration
{
    ...
    $table->decimal('planned_quantity', 15, 3)->comment('الكمية المخططة');
    $table->decimal('produced_quantity', 15, 3)->default(0)->comment('الكمية المنتجة');
    $table->decimal('approved_quantity', 15, 3)->default(0)->comment('الكمية المعتمدة');
    ...
    $table->decimal('estimated_cost', 15, 3)->comment('التكلفة التقديرية');
    $table->decimal('actual_cost', 15, 3)->nullable()->comment('التكلفة الفعلية');
